<div class="px-3">
    <div class="bg-white dark:bg-gray-700 dark:text-white rounded-lg shadow-md p-4 grid grid-cols-2 gap-3 items-center">
        <div class="col-span-2 lg:col-span-1 flex flex-col lg:flex-row gap-2 items-center">
            <div class="flex flex-col pt-4 w-full">
                ...
                <select class="dark:bg-gray-800 dark:text-white dark:border-none" wire:model="level" id="type">
            ...
            <div class="flex flex-col pt-4 w-full">
                ...
                <input class="dark:bg-gray-800 dark:text-white dark:border-none" wire:model="course" type="text" id="course" placeholder='6"b"'>
            </div>
        </div>
        <div class="col-span-2 lg:col-span-1">
            <div class="flex flex-col pt-4">
                ...
                <div class="relative flex-1">
                    <span class="absolute text-gray-600 dark:text-gray-300 inset-y-0 left-0 flex items-center pl-2">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-6 h-6"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    </span>
                    <input wire:model="search" class="w-full pl-10 bg-gray-200 dark:bg-gray-800 border-0 focus:outline-none focus:ring-0 focus:bg-white dark:focus:bg-gray-700 focus:rounded-none focus:shadow-none border-b-2 border-gray-200 dark:border-gray-500 duration-200 dark:text-gray-300" placeholder="Buscar alumno" type="search" id="search">
                </div>
            </div>
        </div>
    </div>
    <div class="flex">
        <a href="{{route('student.create')}}" class="bg-blue-700 cursor-pointer text-white text-lg hover:bg-blue-800 flex-1 w-full py-2 rounded-xl mt-6 text-center">Registrar Nuevo Estudiante</a>
    </div>
    <div class="flex overflow-x-auto w-full mt-4">
        <div class="w-full overflow-x-scroll">
            <table class="w-full overflow-x-auto dark:text-white" x-data="{order_by: '', desc: @entangle('desc')}">
                <thead class="bg-white dark:bg-gray-700 border-b-8 border-gray-100 dark:border-gray-800">
                    <tr>
                        <th>Acciones</th>
                        <th class="p-4 text-left" :class="(order_by == 'lastName') ? 'bg-blue-100 dark:bg-blue-900' : 'bg-white dark:bg-gray-700'">
                        ...
                        <th class="p-4 text-left" :class="(order_by == 'dni') ? 'bg-blue-100 dark:bg-blue-900' : 'bg-white dark:bg-gray-700'">
                        ...
                        <th class="p-4 text-left" :class="(order_by == 'tutor') ? 'bg-blue-100 dark:bg-blue-900' : 'bg-white dark:bg-gray-700'">
                        ...
                        <th class="p-4 text-left" :class="(order_by == 'phone_number') ? 'bg-blue-100 dark:bg-blue-900' : 'bg-white'">
                        ...
                        <th class="p-4 text-left" :class="(order_by == 'house_phone_number') ? 'bg-blue-100 dark:bg-blue-900' : 'bg-white'">
                        ...
                        <th class="p-4 text-left" :class="(order_by == 'email') ? 'bg-blue-100 dark:bg-blue-900' : 'bg-white'" >
                ...
                <tbody>
                    ...
                    @forelse ($students as $student)
                        ...
                        <tr class="shadow-md bg-white dark:bg-gray-700 hover:bg-blue-200 dark:hover:bg-blue-900 duration-300 rounded-xl border-b-8 border-gray-100 dark:border-gray-800">
